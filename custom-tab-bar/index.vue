  ...
  data() {
    return {
      ...
      list: [
        ...
        { pagePath: '/pages/feature/publish/publish', text: '\u53d1\u73b0', iconClass: 'icon-discover' },
        { pagePath: '/pages/info/info', text: '\u4fe1\u606f', iconClass: 'icon-message' },
        { pagePath: '/pages/user/user', text: '\u6211\u7684', iconClass: 'icon-user' }
      ]
    };
  },
  methods: {
