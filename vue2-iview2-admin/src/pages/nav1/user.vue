<template>
  <div>
    ...
    <Modal v-model="detailVisible" title="用户详情" footer-hide width="720">
...
export default {
  data() {
    return {
      ...
      columns: [
        { title: '账号', key: 'studentId', minWidth: 120 },
        ...
        },
        {
          ...
          key: 'status',
          minWidth: 100,
          render: (h, params) => h('span', this.formatStatus(params.row.status))
        },
